...
kotlin {
    ...
    cocoapods {
        summary = "Demo host module for KuiklyCalendar."
        homepage = "https://github.com/AriaLEntropy/KuiklyCalendarView"
        version = "1.0"
...
group = "com.arialentropy.kuiklycalendar"
...
android {
    namespace = "com.arialentropy.kuiklycalendar.shared"
    compileSdk = 34
    defaultConfig {
        minSdk = 21
        targetSdk = 30
